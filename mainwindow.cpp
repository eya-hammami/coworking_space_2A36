...
void MainWindow::on_lineEdit_prenomcher_cursorPositionChanged(int arg1, int arg2)
{
...
void MainWindow::on_lineEdit_chercher_cursorPositionChanged(int arg1, int arg2)
{
    QString inputValue,filtrerChecked;
