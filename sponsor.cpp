...
QSqlQueryModel* Sponsor::afficher_Sponsor_trie_nom(){
    ...
    qry->prepare("Select ID_SPON,NOM_SPON,PRENOM_SPON,MONTANT_PAYES,EMAIL_SPON from GS_SPONSORS order by  Nom_spon where archiver=:val");
    qry->bindValue(":val",val);
...
QSqlQueryModel* Sponsor::afficher_Sponsor_trie_prenom(){
    ...
    qry->prepare("Select ID_SPON,NOM_SPON,PRENOM_SPON,MONTANT_PAYES,EMAIL_SPON from GS_SPONSORS order by Prenom_spon where archiver=:val");
    qry->bindValue(":val",val);
